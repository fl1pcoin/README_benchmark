...
from ReadMeReady_eval.readme_ready.query.create_chat_chain import (
    make_qa_prompt,
    make_readme_prompt,
    make_qa_chain,
    make_readme_chain,
...
def test_make_qa_chain_llama():
    ...
    with patch(
        "ReadMeReady_eval.readme_ready.query.create_chat_chain.get_llama_chat_model"
    ) as mock_get_llama_chat_model, patch(
        "ReadMeReady_eval.readme_ready.query.create_chat_chain.create_stuff_documents_chain"
    ) as mock_create_stuff_chain, patch(
        "ReadMeReady_eval.readme_ready.query.create_chat_chain.create_history_aware_retriever"
    ) as mock_llm_chain, patch(
        "ReadMeReady_eval.readme_ready.query.create_chat_chain.create_retrieval_chain"
...
def test_make_qa_chain_gemma():
    ...
    with patch(
        "ReadMeReady_eval.readme_ready.query.create_chat_chain.get_gemma_chat_model"
...
def test_make_qa_chain_openai():
    ...
    with patch(
        "ReadMeReady_eval.readme_ready.query.create_chat_chain.get_openai_chat_model"
