...
def test_init_qa_chain():
    ...
    with patch(
        "ReadMeReady_eval.readme_ready.query.query.get_embeddings"
    ) as mock_get_embeddings, patch(
        "ReadMeReady_eval.readme_ready.query.query.HNSWLib.load"
    ) as mock_hnswlib_load, patch(
        "ReadMeReady_eval.readme_ready.query.query.make_qa_chain"
...
def test_init_readme_chain():
    ...
    with patch(
        ...
        "ReadMeReady_eval.readme_ready.query.query.make_readme_chain"
...
def test_query_normal():
    ...
    with patch(
        "ReadMeReady_eval.readme_ready.query.query.init_qa_chain"
    ) as mock_init_qa_chain, patch(
        "ReadMeReady_eval.readme_ready.query.query.clear"
    ) as mock_clear, patch(
        "ReadMeReady_eval.readme_ready.query.query.display_welcome_message"
    ) as mock_display_welcome_message, patch(
        "ReadMeReady_eval.readme_ready.query.query.prompt"
    ) as mock_prompt, patch(
        "ReadMeReady_eval.readme_ready.query.query.markdown"
    ) as mock_markdown:
...
def test_query_exception():
    ...
    with patch(
        ...
        "ReadMeReady_eval.readme_ready.query.query.print"
    ) as mock_print, patch(
        "ReadMeReady_eval.readme_ready.query.query.traceback.print_exc"
    ) as mock_print_exc:
...
def test_generate_readme_normal():
    ...
    with patch(
        "ReadMeReady_eval.readme_ready.query.query.init_readme_chain"
