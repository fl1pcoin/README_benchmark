...
from ReadMeReady_eval.readme_ready.index.process_repository import (
    process_repository,
    calculate_checksum,
    should_reindex,
)
from ReadMeReady_eval.readme_ready.types import (
    AutodocRepoConfig,
    ProcessFileParams,
    ProcessFolderParams,
    LLMModels,
...
@patch("ReadMeReady_eval.readme_ready.index.process_repository.traverse_file_system")
@patch("ReadMeReady_eval.readme_ready.index.process_repository.select_model")
@patch(
    "ReadMeReady_eval.readme_ready.index.process_repository.calculate_checksum",
    return_value="checksum123",
)
@patch(
    "ReadMeReady_eval.readme_ready.index.process_repository.should_reindex", return_value=True
)
@patch(
    "builtins.open",
...
@patch("ReadMeReady_eval.readme_ready.index.process_repository.tiktoken.encoding_for_model")
...
@patch("ReadMeReady_eval.readme_ready.index.process_repository.traverse_file_system")
@patch("ReadMeReady_eval.readme_ready.index.process_repository.select_model", return_value=None)
@patch(
    "builtins.open",
    new_callable=mock_open,
...
@patch("ReadMeReady_eval.readme_ready.index.process_repository.select_model")
@patch(
    "ReadMeReady_eval.readme_ready.index.process_repository.should_reindex", return_value=False
)
