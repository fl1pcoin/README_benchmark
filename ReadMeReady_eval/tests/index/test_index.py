...
from ReadMeReady_eval.readme_ready.index.index import index
from ReadMeReady_eval.readme_ready.types import AutodocRepoConfig
...
def test_index(tmp_path):
    ...
    with mock.patch(
        "ReadMeReady_eval.readme_ready.index.index.process_repository"
    ) as mock_process_repository, mock.patch(
        "ReadMeReady_eval.readme_ready.index.index.convert_json_to_markdown"
    ) as mock_convert_json_to_markdown, mock.patch(
        "ReadMeReady_eval.readme_ready.index.index.create_vector_store"
