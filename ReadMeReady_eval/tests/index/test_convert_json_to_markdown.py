...
from ReadMeReady_eval.readme_ready.index.convert_json_to_markdown import (
    convert_json_to_markdown,
)


@patch("ReadMeReady_eval.readme_ready.index.convert_json_to_markdown.traverse_file_system")
@patch("ReadMeReady_eval.readme_ready.index.convert_json_to_markdown.get_file_name")
@patch("ReadMeReady_eval.readme_ready.index.convert_json_to_markdown.FileSummary")
@patch("ReadMeReady_eval.readme_ready.index.convert_json_to_markdown.FolderSummary")
@patch("ReadMeReady_eval.readme_ready.index.convert_json_to_markdown.Path")
