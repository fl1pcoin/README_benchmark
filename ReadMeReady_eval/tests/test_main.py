...
from ReadMeReady_eval.readme_ready.main import *
...
def test_main_readme_mode(mock_questionary):
    ...
    with patch("ReadMeReady_eval.readme_ready.index.index.index") as mock_index, patch(
        "ReadMeReady_eval.readme_ready.query.query.generate_readme"
...
def test_main_query_mode(mock_questionary):
    ...
    with patch("ReadMeReady_eval.readme_ready.index.index.index") as mock_index, patch(
        "ReadMeReady_eval.readme_ready.query.query.query"
    ) as mock_query:
