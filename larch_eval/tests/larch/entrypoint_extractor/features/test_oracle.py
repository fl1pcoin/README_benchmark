from larch_eval.larch.entrypoint_extractor.features.oracle import _extract_entrypoint_from_setuppy, _extract_python_module_exec
...
def test__extract_entrypoint_from_setuppy():
    ...
    setup(
        entry_points={
            'console_scripts':   [
                'larch=larch_eval.larch.cli:cli',
                'larch-server = larch_eval.larch.server:cli',
            ],
        },
