...
from larch_eval.larch.request_models import GenerationRequest
from larch_eval.larch.utils import spinner
...
def setup_local_generator(
        ...
        openai_api_key: Optional[str]) -> larch_eval.larch.generator.BaseGenerator:
    ...
    assert len(larch_eval.larch.generator.AVAILABLE_MODELS) == 1
    return list(larch_eval.larch.generator.AVAILABLE_MODELS.values())[0]
